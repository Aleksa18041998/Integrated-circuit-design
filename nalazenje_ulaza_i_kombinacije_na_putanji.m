...
X5=false;X4=false;X3=true;X2=true;X1=true;X0=true;
X=[X5,X4,X3,X2,X1,X0];
Y5=true;Y4=true;Y3=true;Y2=true;Y1=true;Y0=false;
Y=[Y5,Y4,Y3,Y2,Y1,Y0];
komb=[true,true,true,true,true,true,true,true,true,true,false,false,false,true];
a1=perms(X);
u1=unique(a1,'rows')
